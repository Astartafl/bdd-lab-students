...
public class RegistrationPage extends BasePage {
    ...
    public RegistrationPage setFirstName(String firstName) {
        waitUntilVisible((WebElement) firstNameInput, 10);
        find(firstNameInput).sendKeys(firstName);
        return this;
    }

    public pages.RegistrationPage setLastName(String lastName) {
        find(secondNameInput).sendKeys(lastName);
        return this;
    }

    public pages.RegistrationPage setEmail(String email) {
        find(emailInput).sendKeys(email);
        return this;
    }

    public pages.RegistrationPage setTelephone(String setTelephone) {
        find(telephoneInput).sendKeys(setTelephone);
        return this;
    }

    public pages.RegistrationPage setPassword(String password) {
    ...
    public pages.RegistrationPage clickPrivacyPolicyCheckbox() {
    ...
    public BasePage submitForm() {
        ...
        if (getDriver().getCurrentUrl().contains("register")) {
            ...
            return new pages.SuccessRegistrationPage();
        }
    }
